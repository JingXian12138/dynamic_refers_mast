...
class MAST(nn.Module):
    ...
    def forward(self, rgb_r, quantized_r, rgb_t, ref_index=None,current_ind=None, dil_int=15, dil=-1):
        ...
        quantized_t = self.colorizer(feats_r, feats_t, quantized_r, ref_index, current_ind, dil_int, dil=-1)
        return quantized_t
